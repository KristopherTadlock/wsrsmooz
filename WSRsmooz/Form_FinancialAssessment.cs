...
namespace WSRsmooz
{
    public partial class Form_FinancialAssessment : Form
    {
        // 'global' variables
        ...
        string templatePDF = "templates/5-Financial West Slope Recovery.pdf";
        string newFile;
        ...
        public Form_FinancialAssessment()
        {
            InitializeComponent();
        }
        ...
        private void Form_FinancialAssessment_Load(object sender, EventArgs e)
        {
