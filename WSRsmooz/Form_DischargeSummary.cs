...
namespace WSRsmooz
{
    public partial class Form_DischargeSummary : Form
    {
        // 'global' variables
        ...
        string templatePDF = "templates/4-Discharge Summary.pdf";
        string newFile;
        ...
        private void Form_DischargeSummary_Load(object sender, EventArgs e)
        {
